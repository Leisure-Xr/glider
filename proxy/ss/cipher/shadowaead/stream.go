// 协议格式：
// 格式：[加密后的载荷长度] [开销] [加密后的载荷] [开销]
// 大小：2 字节，aead.Overhead() 字节，n 字节，aead.Overhead() 字节
// max(n): 0x3FFF
...
// NewWriter 使用 AEAD 加密封装一个 io.Writer。
...
// NewReader 使用 AEAD 解密封装一个 io.Reader。
