...
// AESGCM 使用预共享密钥创建新的加密算法。len(psk) 必须为
// 16、24 或 32 之一，以选择 AES-128/196/256-GCM。
...
// Chacha20Poly1305 使用预共享密钥创建新的加密算法。len(psk)
// 必须为 32。
...
// XChacha20Poly1305 使用预共享密钥创建新的加密算法。len(psk)
// 必须为 32。
