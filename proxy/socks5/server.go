...
// ServePacket 实现 proxy.PacketServer 接口。
...
// Handshake 快速完成 SOCKS 初始化以获取要连接的目标地址。
func (s *Socks5) handshake(c net.Conn) (socks.Addr, error) {
	// 参阅 RFC 1928 了解请求和响应结构及大小
